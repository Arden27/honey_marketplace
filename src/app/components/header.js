    ...
    <header className="header">
      <nav className="nav">
        <ul className="nav__items">
          <li className="nav__item"><a href="shop.html">SKLEP</a></li>
          <li className="nav__item"><a href="about.html">O NAS</a></li>
          <li className="nav__item"><a href="articles.html">ARTYKUŁY</a></li>
          <li className="nav__item"><a href="faq.html">FAQ</a></li>
          <li className="nav__item"><a href="contact.html">KONTAKT</a></li>
        </ul>
      </nav>
