export default function Checkbox({ className, children, ...props }) {
  return (
    ...
    >
      <input
        className="relative top-[1px] h-sm w-sm flex-none appearance-none rounded-[2rem] border-2 border-text checked:after:absolute checked:after:-top-[9px] checked:after:left-[3px] checked:after:content-['\2714']  "
        type="checkbox"
      ></input>
