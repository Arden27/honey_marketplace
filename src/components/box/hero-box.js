...
export default function HeroBox() {
  return (
    <section className="relative flex h-[calc(60svh-theme(spacing.3xl)-theme(spacing.2xl)-2*theme(spacing.md))] min-h-[30rem] items-center justify-center overflow-hidden rounded-[2rem]
