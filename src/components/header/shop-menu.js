		...
		<div className="page-wrapper shop-menu-wrapper">
			<div className="shop-menu">
				<div className="shop-menu__item">
					...
					<Link className="shop-menu__item-link" href="/sklep/promocje">
				...
				<div className="shop-menu__item">
					...
					<Link className="shop-menu__item-link" href="/sklep/miody">
				...
				<div className="shop-menu__item">
					...
					<Link className="shop-menu__item-link" href="/sklep/swiece">
				...
				<div className="shop-menu__item">
					...
					<Link className="shop-menu__item-link" href="/sklep/zestawy">
