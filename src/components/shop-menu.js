  ...
  return (
    <section className="w-100 page-wrapper [&_img]:rh-shop-menu-img hidden h-shop-menu grid-cols-5 pb-2xl md:grid [&>*]:grid [&>*]:justify-items-center [&_h2]:mt-xs [&_h2]:text-center [&_h2]:text-base [&_h2]:uppercase [&_img]:h-shop-menu-img [&_img]:w-shop-menu-img [&_img]:rounded-full">
      <div>
        ...
        <Link href="/sklep/promocje">
          <h2>Promocje</h2>
        </Link>
      </div>
      <div>
        <Link href="/sklep/miody" aria-hidden="true" tabIndex={-1}>
          <Image src="/img/logo.png" width={80} height={80} alt="Miody" />
        </Link>
        <Link href="/sklep/miody">
          <h2>Miody</h2>
        </Link>
      </div>
      <div>
        <Link href="/sklep/produkty-pszczele" aria-hidden="true" tabIndex={-1}>
          <Image
            src="/img/logo.png"
            width={80}
            height={80}
        ...
        <Link href="/sklep/produkty-pszczele">
          <h2 className="max-w-[20rem]">Produkty Pszczele</h2>
        </Link>
      </div>
      <div>
        <Link href="/sklep/swiece" aria-hidden="true" tabIndex={-1}>
          <Image src="/img/logo.png" width={80} height={80} alt="Świece" />
        </Link>
        <Link href="/sklep/swiece">
          <h2>Świece</h2>
        </Link>
      </div>
      <div>
        <Link href="/sklep/zestawy" aria-hidden="true" tabIndex={-1}>
          <Image
